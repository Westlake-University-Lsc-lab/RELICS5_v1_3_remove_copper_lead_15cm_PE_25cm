...
EventLoaderMessenger::EventLoaderMessenger(EventLoader* loader)
  : myLoader{loader},
    loaderDir{new G4UIdirectory("/evtloader/")},
    ...
    upVecCmd{new G4UIcmdWith3Vector("/evtloader/upvec", this)}
{
  ...
  confineCmd->SetGuidance("Set confine of event loader (available for cylinder)");
...
void EventLoaderMessenger::SetNewValue(G4UIcommand* command, G4String newValues)
{
