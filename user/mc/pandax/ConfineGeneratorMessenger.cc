...
void ConfineGeneratorMessenger::SetNewValue(G4UIcommand* command, G4String newValues)
{
  ...
  else if (command == ionCmd.get())
  {
    ...
    auto ion = particleTable->GetIonTable()->GetIon(atomicNumber, atomicMass, 0);
    if (ion == nullptr)
    {
