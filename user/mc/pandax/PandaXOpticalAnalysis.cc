...
AnalysisRegister<PandaXOpticalAnalysis> PandaXOpticalAnalysis::reg("PandaXOpticalAnalysis");

PandaXOpticalAnalysis::PandaXOpticalAnalysis(const BambooParameters& pars) : BambooAnalysis{pars}
{
  ...
  runAction = new PandaXOpticalRunAction(analysisParameters.getParameter("DataFileName"));
