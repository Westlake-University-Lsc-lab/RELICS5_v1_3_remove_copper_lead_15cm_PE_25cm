...
AnalysisRegister<RelicsOpticalAnalysis> RelicsOpticalAnalysis::reg("RelicsOpticalAnalysis");

RelicsOpticalAnalysis::RelicsOpticalAnalysis(const BambooParameters& pars) : BambooAnalysis{pars}
{
  ...
  if (analysisParameters.getParameters().find("EnableEnergyDeposition")
    ...
    enable_energy_deposition = analysisParameters.getParameter<bool>("EnableEnergyDeposition");
  bool enable_primary_particle = analysisParameters.getParameter<bool>("EnablePrimaryParticle");
  bool save_null_events = analysisParameters.getParameter<bool>("SaveNullEvents");
  bool get_geo_mass = analysisParameters.getParameter<bool>("GetGeoMass");
  ...
  runAction =
    new RelicsOpticalRunAction(analysisParameters.getParameter("DataFileName"), get_geo_mass);
