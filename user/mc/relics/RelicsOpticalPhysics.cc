...
PhysicsRegister<RelicsOpticalPhysics> RelicsOpticalPhysics::reg("RelicsOpticalPhysics");

RelicsOpticalPhysics::RelicsOpticalPhysics(const BambooParameters& pars) : BambooPhysics(pars)
{
