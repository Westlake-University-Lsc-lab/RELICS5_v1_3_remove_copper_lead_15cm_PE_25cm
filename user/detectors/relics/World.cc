...
World::World(const std::string& n, const BambooParameters& pars) : BambooDetector(n, pars)
{
...
bool World::construct(const BambooParameters&, BambooDetector*)
{
  ...
  mainLV = new G4LogicalVolume(worldBox, air, "WorldLog", nullptr, nullptr, nullptr);
  mainPV = new G4PVPlacement(nullptr, G4ThreeVector(), mainLV, "World", nullptr, false, 0);
  containerLV = mainLV;
  containerPV = mainPV;
