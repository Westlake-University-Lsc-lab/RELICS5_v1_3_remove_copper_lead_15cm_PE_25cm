...
bool Monoblock::construct(const BambooParameters& pars, BambooDetector* parent)
{
  ...
  mainPV = new G4PVPlacement(nullptr, G4ThreeVector(shift_x, shift_y, shift_z), mainLV, physvol,
                             parent->getContainerLV(), false, 0, check_overlap);
  containerLV = mainLV;
  containerPV = mainPV;
