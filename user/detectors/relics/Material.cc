...
void Material::defineMaterials(const BambooParameters &parameters)
{
    ...
    G4MaterialPropertiesTable *pSSPropertiesTable =
        new G4MaterialPropertiesTable();
    pSSPropertiesTable->AddProperty("REFLECTIVITY", pSS304LSteelPhotonMomentum, pSS304LSteelRefractiveIndex, 2);
    pSSPropertiesTable->AddProperty("TRANSMITTANCE", pSS304LSteelPhotonMomentum, pSS304LSteelTransmittance, 2);
    ...
    // ==== Flange ====
    G4Material *Flange =
        new G4Material("Flange", 8.00 * g / cm3, 5, kStateSolid);
    ...
    G4MaterialPropertiesTable *pFlangePropertiesTable =
        new G4MaterialPropertiesTable();
    pFlangePropertiesTable->AddProperty("REFLECTIVITY", pFlangePhotonMomentum, pFlangeRefractiveIndex, 2);
    pFlangePropertiesTable->AddProperty("TRANSMITTANCE", pFlangePhotonMomentum, pFlangeTransmittance, 2);
    ...
    G4MaterialPropertiesTable *pTeflonGasPropertiesTable =
        new G4MaterialPropertiesTable();
    ...
    pTeflonGasPropertiesTable->AddProperty("SPECULARLOBECONSTANT",
                                           pTeflonGasPhotonMomentum,
                                           pTeflonGasSpecularLobe, 3);
    pTeflonGasPropertiesTable->AddProperty("SPECULARSPIKECONSTANT",
                                           pTeflonGasPhotonMomentum,
                                           pTeflonGasSpecularSpike, 3);
    pTeflonGasPropertiesTable->AddProperty("BACKSCATTERCONSTANT",
                                           pTeflonGasPhotonMomentum,
