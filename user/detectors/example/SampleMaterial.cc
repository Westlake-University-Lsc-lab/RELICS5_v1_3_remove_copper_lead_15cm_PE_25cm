...
void SampleMaterial::defineMaterials(const BambooParameters&)
{
  ...
  auto vacuum = new G4Material("vacuum", vacuumAtomicNumber, vacuumMassOfMole, vacuumDensity,
  ...
  auto stainlessSteel = pNistManager->FindOrBuildMaterial("G4_STAINLESS-STEEL");
