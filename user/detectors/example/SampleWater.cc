...
DetectorRegister<SampleWater, std::string, BambooParameters> SampleWater::reg("SampleWater");
...
bool SampleWater::construct(const BambooParameters&, BambooDetector* parent)
{
  ...
  auto waterBox = new G4Box("WaterBox", width_x / 2, width_y / 2, width_z / 2);
  ...
  mainPV = new G4PVPlacement(0, G4ThreeVector(), mainLV, "SampleWater", parent->getContainerLV(),
                             false, 0);
