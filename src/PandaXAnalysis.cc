...
PandaXAnalysis::PandaXAnalysis(const BambooParameters& pars) : BambooAnalysis(pars)
{
  ...
  bool enable_surface_flux = analysisParameters.getParameter<bool>("EnableSurfaceFlux");
  ...
  runAction = new PandaXRunAction(analysisParameters.getParameter("DataFileName"));
