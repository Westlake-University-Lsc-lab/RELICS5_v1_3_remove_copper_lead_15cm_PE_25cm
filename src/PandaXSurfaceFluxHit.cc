...
const PandaXSurfaceFluxHit& PandaXSurfaceFluxHit::operator=(const PandaXSurfaceFluxHit& right)
{
...
double PandaXSurfaceFluxHit::getEnergy() const
{
  return energy_;
}

std::string PandaXSurfaceFluxHit::getTrackName() const
{
  return trackName_;
}

std::string PandaXSurfaceFluxHit::getParentName() const
{
  return parentName_;
}

G4ThreeVector PandaXSurfaceFluxHit::getMomentum() const
{
  return momentum_;
}

void PandaXSurfaceFluxHit::setEnergy(double energy)
{
  energy_ = energy;
}
