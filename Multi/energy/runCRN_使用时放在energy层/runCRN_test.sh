...
export RELICSSIM=/public/home/yyy/RELICS5各个版本/RELICS5_v1/RELICS5_v1_3_remove_copper   # Need update
export ANALYSIS=/public/home/yyy/RELICS5各个版本/RELICS5_v1/RELICS5_v1_3_remove_copper/Multi/energy   # Need update
...
export FOLDER=/public/home/yyy/RELICS5各个版本/RELICS5_v1/RELICS5_v1_3_remove_copper各个版本/RELICS5_v1/RELICS5_v1_3_remove_copper/result/Multi_test  # Need update
export SUFFIX="_CRN"
jq ".$SUFFIX=100" $norm | sponge $norm
./run.sh -m CRN -f $(expr $files ) -j $parallel -e $(expr $events \* 100) $clean $justprint
