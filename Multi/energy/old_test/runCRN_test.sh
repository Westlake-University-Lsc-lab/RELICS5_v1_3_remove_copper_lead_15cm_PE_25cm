...
export FOLDER=/public/home/yyy/RELICS5各个版本/RELICS5_v1/RELICS5_v1_3_remove_copper/result/Multi_test  # Need update
export SUFFIX="_CRN"
jq ".$SUFFIX=200" $norm | sponge $norm
./run.sh -m CRN -f $(expr $files \* 10) -j $parallel -e $(expr $events \* 20) $clean $justprint
