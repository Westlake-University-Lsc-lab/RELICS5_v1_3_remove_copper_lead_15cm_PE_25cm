...
export FOLDER=/public/home/yyy/RELICS5各个版本/RELICS5_v1/RELICS5_v1_3_remove_copper/result/Multi_test_muon  # Need update
export SUFFIX="_muon"
jq ".$SUFFIX=100" $norm | sponge $norm
./run.sh -m muon -f $(expr $files) -j $parallel -e $(expr $events \* 100) $clean $justprint
